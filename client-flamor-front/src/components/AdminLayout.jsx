...
const AdminLayout = ({ children }) => {
  return (
    <div
      style={{ display: "flex", minHeight: "100vh", marginTop: "-7rem" }}
    >
      {/* Sidebar */}
      <aside
        style={{
      ...
      >
        ...
        >
          ...
          <NavLink to="/AdminUsers" style={linkStyle}>
            Users
          </NavLink>
          <NavLink to="/AdminCategory" style={linkStyle}>
            Category
          </NavLink>
          <NavLink to="/AdminProducts" style={linkStyle}>
            Products
          </NavLink>
          <NavLink to="/adminReview" style={linkStyle}>
            Reviews
          </NavLink>
          <NavLink to="/adminShippingPage" style={linkStyle}>
            Orders
          </NavLink>
